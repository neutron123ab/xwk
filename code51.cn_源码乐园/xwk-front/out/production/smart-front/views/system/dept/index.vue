  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="学院名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入学院名称" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="deptList" row-key="id" default-expand-all
      ...
      <el-table-column prop="name" label="学院名称" width="260"></el-table-column>
        ...
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item label="上级学院" prop="parentId">
              <treeselect v-model="form.parentId" :options="deptOptions" :normalizer="normalizer" placeholder="选择上级学院" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="学院名称" prop="name">
