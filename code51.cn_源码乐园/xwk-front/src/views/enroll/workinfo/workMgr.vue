  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="状态" prop="statusInfo">
        <el-input v-model="queryParams.statusInfo" placeholder="请输入状态" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-form-item label="评分" prop="getScore">
        <el-input v-model="queryParams.getScore" placeholder="请输入评分" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                   v-hasPermi="['enroll:work-info:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="参赛作品" prop="workInfo">
          <el-input v-model="form.workInfo" placeholder="请输入参赛作品" />
        </el-form-item>
        <el-form-item label="评分" prop="getScore">
          <el-input v-model="form.getScore" placeholder="请输入评分" />
        </el-form-item>
      </el-form>
