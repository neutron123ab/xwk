    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        <div class="head-container">
          <el-input v-model="deptName" placeholder="请输入学院名称" clearable size="small"
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="学院" align="center" prop="dept.name" :show-overflow-tooltip="true" />
          ...
          <el-col :span="12">
            <el-form-item label="归属学院" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true"
                          placeholder="请选择归属学院" :normalizer="normalizer"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
