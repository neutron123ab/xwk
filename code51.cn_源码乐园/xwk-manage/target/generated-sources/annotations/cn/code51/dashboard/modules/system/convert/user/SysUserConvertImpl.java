package cn.code51.dashboard.modules.system.convert.user;

import cn.code51.dashboard.modules.system.controller.user.vo.profile.SysUserProfileRespVO;
import cn.code51.dashboard.modules.system.controller.user.vo.profile.SysUserProfileRespVO.Post;
import cn.code51.dashboard.modules.system.controller.user.vo.profile.SysUserProfileRespVO.Role;
...
import cn.code51.dashboard.modules.system.controller.user.vo.user.SysUserCreateReqVO;
import cn.code51.dashboard.modules.system.controller.user.vo.user.SysUserExcelVO;
import cn.code51.dashboard.modules.system.controller.user.vo.user.SysUserImportExcelVO;
import cn.code51.dashboard.modules.system.controller.user.vo.user.SysUserPageItemRespVO;
import cn.code51.dashboard.modules.system.controller.user.vo.user.SysUserPageItemRespVO.Dept;
import cn.code51.dashboard.modules.system.controller.user.vo.user.SysUserUpdateReqVO;
...
import cn.code51.dashboard.modules.system.dal.dataobject.user.SysUserDO.SysUserDOBuilder;
...
public class SysUserConvertImpl implements SysUserConvert {
    ...
    @Override
    public cn.code51.dashboard.modules.system.controller.user.vo.profile.SysUserProfileRespVO.Dept convert02(SysDeptDO bean) {
        if ( bean == null ) {
            return null;
        }

        cn.code51.dashboard.modules.system.controller.user.vo.profile.SysUserProfileRespVO.Dept dept = new cn.code51.dashboard.modules.system.controller.user.vo.profile.SysUserProfileRespVO.Dept();
