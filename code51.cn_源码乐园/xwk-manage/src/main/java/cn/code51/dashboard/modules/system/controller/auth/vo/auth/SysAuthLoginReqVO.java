package cn.code51.dashboard.modules.system.controller.auth.vo.auth;
...
public class SysAuthLoginReqVO {
    ...
    @ApiModelProperty(value = "账号", required = true, example = "teachsystemyuanma")
    @NotEmpty(message = "登陆账号不能为空")
    @Length(min = 2, max = 16, message = "账号长度为 2-16 位")
