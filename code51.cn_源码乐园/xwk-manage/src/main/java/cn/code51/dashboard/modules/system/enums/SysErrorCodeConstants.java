package cn.code51.dashboard.modules.system.enums;
...
public interface SysErrorCodeConstants {
    ...
    // ========== 学院模块 1002005000 ==========
    ErrorCode DEPT_NAME_DUPLICATE = new ErrorCode(1002004001, "已经存在该名字的学院");
    ErrorCode DEPT_PARENT_NOT_EXITS = new ErrorCode(1002004002,"父级学院不存在");
    ErrorCode DEPT_NOT_FOUND = new ErrorCode(1002004003, "当前学院不存在");
    ErrorCode DEPT_EXITS_CHILDREN = new ErrorCode(1002004004, "存在子学院，无法删除");
    ErrorCode DEPT_PARENT_ERROR = new ErrorCode(1002004005, "不能设置自己为父学院");
    ErrorCode DEPT_EXISTS_USER = new ErrorCode(1002004006, "学院中存在员工，无法删除");
    ErrorCode DEPT_NOT_ENABLE = new ErrorCode(1002004007, "学院不处于开启状态，不允许选择");
    ErrorCode DEPT_PARENT_IS_CHILD = new ErrorCode(1002004008, "不能设置自己的子学院为父学院");
