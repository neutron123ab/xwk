...
/**
 * 学院 Base VO，提供给添加、修改、详细的子 VO 使用
 * 如果子 VO 存在差异的字段，请不要添加到这里，影响 Swagger 文档生成
 */
@Data
public class SysDeptBaseVO {

    @ApiModelProperty(value = "菜单名称", required = true, example = "教研")
    @NotBlank(message = "学院名称不能为空")
    @Size(max = 30, message = "学院名称长度不能超过30个字符")
    private String name;
    ...
    @ApiModelProperty(value = "负责人", example = "教研")
    ...
    @ApiModelProperty(value = "邮箱", example = "system@iocoder.cn")
