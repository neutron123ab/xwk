package cn.code51.dashboard.modules.tool.controller.codegen.vo.table;
...
public class ToolCodegenTableBaseVO {
    ...
    @ApiModelProperty(value = "表名称", required = true, example = "system")
    @NotNull(message = "表名称不能为空")
    private String tableName;

    @ApiModelProperty(value = "表描述", required = true, example = "智慧")
    ...
    @ApiModelProperty(value = "作者", required = true, example = "智慧源码")
