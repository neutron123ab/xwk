package cn.code51.dashboard.modules.system.service.dict.impl;
...
import cn.code51.dashboard.modules.system.dal.mysql.dict.SysDictDataMapper;
import cn.code51.dashboard.modules.system.enums.SysErrorCodeConstants;
import cn.code51.dashboard.modules.system.mq.producer.dict.SysDictDataProducer;
import cn.hutool.core.collection.CollUtil;
import cn.code51.dashboard.modules.system.controller.dict.vo.data.SysDictDataCreateReqVO;
import cn.code51.dashboard.modules.system.controller.dict.vo.data.SysDictDataExportReqVO;
import cn.code51.dashboard.modules.system.controller.dict.vo.data.SysDictDataPageReqVO;
import cn.code51.dashboard.modules.system.controller.dict.vo.data.SysDictDataUpdateReqVO;
import cn.code51.dashboard.modules.system.convert.dict.SysDictDataConvert;
import cn.code51.dashboard.modules.system.service.dict.SysDictDataService;
import cn.code51.dashboard.modules.system.service.dict.SysDictTypeService;
...
public class SysDictDataServiceImpl implements SysDictDataService {
    ...
    public void checkDictDataValueUnique(Long id, String dictType, String value) {
        ...
        if (id == null) {
            throw ServiceExceptionUtil.exception(SysErrorCodeConstants.DICT_DATA_VALUE_DUPLICATE);
        }
    ...
    public void checkDictDataExists(Long id) {
        ...
        if (dictData == null) {
            throw ServiceExceptionUtil.exception(SysErrorCodeConstants.DICT_DATA_NOT_EXISTS);
        }
    }
    ...
    public void checkDictTypeValid(String type) {
        ...
        if (!CommonStatusEnum.ENABLE.getStatus().equals(dictType.getStatus())) {
            throw ServiceExceptionUtil.exception(SysErrorCodeConstants.DICT_TYPE_NOT_ENABLE);
        }
    }
