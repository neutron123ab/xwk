package cn.code51.dashboard.modules.system.controller.permission.vo.permission;
...
//    TODO 这里要多一个枚举校验
    ...
    @ApiModelProperty(value = "学院编号列表", example = "1,3,5", notes = "只有范围类型为 DEPT_CUSTOM 时，该字段才需要")
