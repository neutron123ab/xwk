...
import cn.code51.dashboard.modules.tool.enums.codegen.ToolCodegenColumnHtmlTypeEnum;
import cn.code51.dashboard.modules.tool.enums.codegen.ToolCodegenColumnListConditionEnum;
import cn.code51.dashboard.modules.tool.enums.codegen.ToolCodegenTemplateTypeEnum;
...
public class ToolCodegenBuilder {
    ...
    private void initTableDefault(ToolCodegenTableDO table) {
        ...
        table.setClassComment(subBefore(table.getTableComment(), // 去除结尾的表，作为类描述
                '表', true));
        table.setAuthor("教研源码"); // TODO 稍后改成创建人
