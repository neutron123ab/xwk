/*
 * Copyright 2014-2018 xfami.com. All rights reserved.
 * Support: https://www.xfami.com
 */
package cn.code51.dashboard.common.utils;
...
public final class DateTimeUtil {
    ...
    public static boolean isDateBetweenStartToEnd(Date start,Date end,Date current){
     ...
     * @param endTime
     *            结束日期
     * @return   getDays("2018-06-28", "2018-07-3") ;
     * [2018-06-28, 2018-06-29, 2018-06-30, 2018-07-01, 2018-07-02, 2018-07-03]
     */
    public static List<String> getDaysBtTwoDayStr(String startTime, String endTime) {
    ...
    public static void main(String[] args) {
        ...
        String s = formatDateTimetoString(date, FMT_yyyyMMddHHmmss);
        System.out.println(s);
        Date zeroDate = getZeroDate(date);
        String s1 = formatDateTimetoString(zeroDate, FMT_yyyyMMddHHmmss);
