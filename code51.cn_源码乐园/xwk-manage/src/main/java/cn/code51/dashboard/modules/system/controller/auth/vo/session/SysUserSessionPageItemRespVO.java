package cn.code51.dashboard.modules.system.controller.auth.vo.session;
...
@ApiModel(value = "用户在线 Session Response VO", description = "相比用户基本信息来说，会多学院、用户账号等信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class SysUserSessionPageItemRespVO extends PageParam {
    ...
    @ApiModelProperty(value = "学院名称", example = "研发部")
